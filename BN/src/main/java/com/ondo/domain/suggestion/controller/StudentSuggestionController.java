...
public class StudentSuggestionController {
    ...
    public ResponseEntity<List<SuggestionResponseDTO>> getMyPosts(Authentication authentication) {
        return ResponseEntity.ok(suggestionService.getMyPosts(authentication.getName(), Role.STUDENT));
    }
    ...
    public ResponseEntity<SuggestionResponseDTO> getPost(
        ...
        return ResponseEntity.ok(suggestionService.getPost(authentication.getName(), Role.STUDENT, id));
    }
    ...
    public ResponseEntity<Map<String, String>> delete(
        ...
        suggestionService.delete(authentication.getName(), Role.STUDENT, id);
