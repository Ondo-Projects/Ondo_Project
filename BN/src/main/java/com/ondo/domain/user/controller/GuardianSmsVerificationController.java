...
public class GuardianSmsVerificationController {
    ...
    @PostMapping("/send")
    public ResponseEntity<Map<String, String>> sendCode(@Valid @RequestBody GuardianSmsSendRequestDTO request) {
        guardianSmsVerificationService.sendVerificationCode(request);
