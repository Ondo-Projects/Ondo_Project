...
@Transactional
class CommonWeatherControllerTest {

    private static final String STUDENT_USERNAME = "it-common-weather-student";
    private static final String TEACHER_USERNAME = "it-common-weather-teacher";
    ...
    @Test
    void getTodayWeather_returnsSampleWeatherForStudent() throws Exception {
        String token = jwtProvider.createAccessToken(STUDENT_USERNAME, Role.STUDENT);

        mockMvc.perform(get("/api/common/weather/today")
    ...
    @Test
    void getTodayWeather_returnsSampleWeatherForTeacher() throws Exception {
